...
const Settings = () => {
  ...
  return (
    <div ref={scrollContainerRef} className="h-screen overflow-y-auto bg-gray-50 dark:bg-gray-900 pb-24">
      {/* Hero Header */}
      <div 
      ...
      <div className="max-w-3xl mx-auto px-4 py-6 space-y-8">
        {/* Profile Section */}
        <section>
          <h2 className="text-[13px] font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2 px-4 pt-4">Profile Settings</h2>
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-4 sm:p-5 space-y-6">
            {/* Add Profile Picture */}
            <div className="flex justify-center">
              <div className="relative group/avatar">
                <div className="absolute inset-0 bg-blue-600 rounded-full blur-sm opacity-20 group-hover/avatar:opacity-40 transition-opacity"></div>
        ...
        {/* Password Section */}
        <section>
          <h2 className="text-[13px] font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2 px-4">Change Password</h2>
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-4 sm:p-5 space-y-5">
            <div className="relative">
        ...
        <section>
          <h2 className="text-[13px] font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2 px-4">Notification Settings</h2>
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-4 sm:p-5 space-y-6">
                  ...
                  <div className="flex items-center justify-between p-4 rounded-2xl bg-white/30 dark:bg-gray-900/30 backdrop-blur-sm hover:bg-white/50 dark:hover:bg-gray-900/50 transition-all">
                    ...
                    <div className="relative ml-4">
                      <Switch
                        ...
                        className={`${
                          notificationSettings.chatNotifications ? 'bg-blue-500' : 'bg-gray-300 dark:bg-gray-600'
                  ...
                  <div className="flex items-center justify-between p-4 rounded-2xl bg-white/30 dark:bg-gray-900/30 backdrop-blur-sm hover:bg-white/50 dark:hover:bg-gray-900/50 transition-all">
                    ...
                    <div className="relative ml-4">
                      <Switch
                        ...
                        disabled={isSubmitting || !isOnline}
                        className={`${
                          notificationSettings.topicNotifications ? 'bg-blue-500' : 'bg-gray-300 dark:bg-gray-600'
                        } relative inline-flex h-7 w-14 items-center rounded-full transition-all duration-200 focus:outline-none focus:ring-4 focus:ring-blue-500/30 ${
                          isSubmitting ? 'opacity-50 cursor-not-allowed' : 'shadow-md'
                        }`}
                      >
                  ...
                  <div className="flex items-center justify-between p-4 rounded-2xl bg-white/30 dark:bg-gray-900/30 backdrop-blur-sm hover:bg-white/50 dark:hover:bg-gray-900/50 transition-all">
                    ...
                    <div className="relative ml-4">
                      <Switch
                        ...
                        disabled={isSubmitting || !isOnline}
                        className={`${
                          notificationSettings.systemNotifications ? 'bg-blue-500' : 'bg-gray-300 dark:bg-gray-600'
                        } relative inline-flex h-7 w-14 items-center rounded-full transition-all duration-200 focus:outline-none focus:ring-4 focus:ring-blue-500/30 ${
                          isSubmitting ? 'opacity-50 cursor-not-allowed' : 'shadow-md'
                        }`}
                      >
        ...
        {/* Privacy Settings */}
        <section>
          <h2 className="text-[13px] font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2 px-4">Privacy</h2>
            ...
            {Object.entries(privacy).map(([key, enabled]) => (
              <div key={key} className="flex items-center justify-between p-4 rounded-2xl bg-white/30 dark:bg-gray-900/30 backdrop-blur-sm hover:bg-white/50 dark:hover:bg-gray-900/50 transition-all">
                ...
                <Switch
                  ...
                  } relative inline-flex h-7 w-14 items-center rounded-full transition-all duration-200 focus:outline-none focus:ring-4 focus:ring-blue-500/30 shadow-sm`}
                >
                  <span
                    className={`${
        ...
        {/* Theme Settings */}
        <section>
          <h2 className="text-[13px] font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2 px-4">Theme</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <button
                ...
                className={`p-4 rounded-xl border-2 ${
                  theme === 'light' ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/10' : 'border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800'
                } hover:border-blue-400 flex items-center justify-center gap-3 transition-colors duration-200`}
              >
                <SunIcon className={`h-5 w-5 ${theme === 'light' ? 'text-blue-600' : 'text-gray-500'}`} />
                <span className={`font-medium ${theme === 'light' ? 'text-blue-700 dark:text-blue-400' : 'text-gray-700 dark:text-gray-300'}`}>Light</span>
              </button>
              <button
                onClick={() => handleThemeChange('dark')}
                className={`p-4 rounded-xl border-2 ${
                  theme === 'dark' ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/10' : 'border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800'
                } hover:border-blue-400 flex items-center justify-center gap-3 transition-colors duration-200`}
              >
                <MoonIcon className={`h-5 w-5 ${theme === 'dark' ? 'text-blue-600' : 'text-gray-500'}`} />
                <span className={`font-medium ${theme === 'dark' ? 'text-blue-700 dark:text-blue-400' : 'text-gray-700 dark:text-gray-300'}`}>Dark</span>
              </button>
              <button
                onClick={() => handleThemeChange('system')}
                className={`p-4 rounded-xl border-2 ${
                  theme === 'system' ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/10' : 'border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800'
                } hover:border-blue-400 flex items-center justify-center gap-3 transition-colors duration-200`}
              >
                <ComputerDesktopIcon className={`h-5 w-5 ${theme === 'system' ? 'text-blue-600' : 'text-gray-500'}`} />
                <span className={`font-medium ${theme === 'system' ? 'text-blue-700 dark:text-blue-400' : 'text-gray-700 dark:text-gray-300'}`}>System</span>
              </button>
            </div>
          </div>
        </section>
        ...
        {/* Data Management */}
        <section>
          <h2 className="text-[13px] font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2 px-4">Data Management</h2>
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-4 sm:p-5 space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <button
                onClick={handleClearTopics}
                disabled={isClearing}
                className="p-4 rounded-xl border border-red-200 dark:border-red-800 bg-white dark:bg-gray-800 hover:bg-red-50 dark:hover:bg-red-900/20 flex flex-col items-center justify-center gap-2 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                <TrashIcon className="h-6 w-6 text-red-500" />
                <span className="font-medium text-red-600 dark:text-red-400">Clear All Topics</span>
              </button>
              <button
                onClick={handleResetSettings}
                disabled={isSubmitting}
                className="p-4 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 flex flex-col items-center justify-center gap-2 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                <ArrowPathIcon className="h-6 w-6 text-gray-500" />
                <span className="font-medium text-gray-700 dark:text-gray-300">Reset All Settings</span>
              </button>
            </div>
          </div>
        </section>

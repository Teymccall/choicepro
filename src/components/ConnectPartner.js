...
const ConnectPartner = () => {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 p-6 sm:p-8 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.08)] border border-gray-100/50 dark:border-gray-700">
      <div className="text-center mb-7">
        <h2 className="text-[22px] font-black tracking-tight text-gray-900 dark:text-white mb-1.5">Connect with Partner</h2>
        <p className="text-[14px] font-medium text-gray-500 dark:text-gray-400">
          Enter an invite code to pair your accounts
        </p>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          <div className="relative">
            <label htmlFor="inviteCode" className="absolute -top-2 left-4 px-1.5 bg-white dark:bg-gray-800 text-[10px] font-bold text-gray-500 uppercase tracking-widest z-10">
              Invite Code
            </label>
            <input
              id="inviteCode"
              ...
              placeholder="------"
              className="block w-full px-5 py-4 bg-transparent border-2 border-gray-200 dark:border-gray-700 rounded-2xl placeholder-gray-300 dark:placeholder-gray-600 focus:outline-none focus:ring-0 focus:border-blue-500 text-center uppercase tracking-[0.5em] font-black text-[22px] text-gray-900 dark:text-white transition-colors duration-300"
              maxLength={6}
            />
          </div>
        ...
        {!activeInviteCode && (
          <button
            ...
            disabled={isLoading}
            className="w-full inline-flex items-center justify-center px-6 py-4 bg-blue-50 hover:bg-blue-100 dark:bg-gray-800 text-blue-600 font-bold rounded-2xl transition-colors duration-200"
          >

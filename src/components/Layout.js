...
const Layout = ({ children }) => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 transition-colors duration-200">
      ...
      {/* Permission prompt for calls */}
      {webRTC && webRTC.showPermissionPrompt && (
        <PermissionPrompt
          callType={webRTC.pendingCallType || 'audio'}
          onProceed={() => webRTC.startCall(webRTC.pendingCallType || 'audio')}
